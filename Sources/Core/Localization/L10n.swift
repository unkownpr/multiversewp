...
public enum L10n {
    ...
    static let strings: [String: [String: String]] = [
        "en": [
            ...
            "mcp.tool.getMessages": "get_messages(chat_id, before?, limit?) — fetch history",
            "mcp.tool.searchMessages": "search_messages(query, account_id?, chat_id?, limit?) — FTS5 over the local store",
            "mcp.tool.sendMessage": "send_message — coming in a later milestone (explicit per-chat approval)",
            "mcp.tool.downloadMedia": "download_media — coming in a later milestone (explicit per-chat approval)",
            ...
            "mcp.howToUse.consent": "Write tools (send_message, download_media) will require per-chat consent prompts when they ship in a later milestone.",
        ...
        "tr": [
            ...
            "mcp.tool.getMessages": "get_messages(chat_id, before?, limit?) — geçmişi getirir",
            "mcp.tool.searchMessages": "search_messages(query, account_id?, chat_id?, limit?) — yerel depoda FTS5 araması",
            "mcp.tool.sendMessage": "send_message — sonraki sürümde (sohbet bazlı onay gerekli)",
            "mcp.tool.downloadMedia": "download_media — sonraki sürümde (sohbet bazlı onay gerekli)",
            ...
            "mcp.howToUse.consent": "Yazma araçları (send_message, download_media) yayına girdiğinde sohbet bazlı onay isteyecek.",

...
public enum L10n {
    ...
    static let strings: [String: [String: String]] = [
        "en": [
            ...
            "settings.notifications.description": "Banner alerts and sound when a new WhatsApp message arrives. Requires macOS permission.",
            "settings.notifications.status": "Status",
            "settings.notifications.status.authorized": "Allowed",
            "settings.notifications.status.denied": "Denied — change it in System Settings",
            "settings.notifications.status.notDetermined": "Not requested yet",
            "settings.notifications.status.provisional": "Quiet (provisional)",
            "settings.notifications.status.unknown": "Unknown",
            "settings.notifications.request": "Request permission",
            ...
            "chat.detail.header.typing": "typing…",
            "chat.detail.header.recording": "recording audio…",
            "chat.detail.header.lastSeen": "last seen %@",
            "chat.detail.header.lastSeenJustNow": "last seen just now",
        ...
        "tr": [
            ...
            "settings.notifications.heading": "Sistem bildirimleri",
            "settings.notifications.description": "Yeni WhatsApp mesajı geldiğinde banner ve ses çalar. macOS izni gerekli.",
            "settings.notifications.status": "Durum",
            "settings.notifications.status.authorized": "İzin verildi",
            "settings.notifications.status.denied": "Reddedildi — Sistem Ayarları'ndan değiştir",
            "settings.notifications.status.notDetermined": "Henüz sorulmadı",
            "settings.notifications.status.provisional": "Sessiz (geçici)",
            "settings.notifications.status.unknown": "Bilinmiyor",
            "settings.notifications.request": "İzin iste",
            "settings.notifications.openSettings": "Sistem Ayarları'nı aç",
            ...
            "chat.detail.header.typing": "yazıyor…",
            "chat.detail.header.recording": "ses kaydediyor…",
            "chat.detail.header.lastSeen": "son görülme %@",
            "chat.detail.header.lastSeenJustNow": "son görülme az önce",
